...
def calculate_reactivity(fuel: Fuel, T_i: u.Quantity) -> u.Quantity[u.m**3 / u.s]:
    ...
    if fuel.name == 'D-T':
        # This is the simplified analytical fit from the NRL Plasma Formulary (2019), pg. 46.
        # It is robust and accurate for the temperature range of interest.
        # The formula gives reactivity in cm^3/s.
        A1 = 5.0e-12
        B1 = 19.94
        sigma_v_cm3_s = A1 * np.exp(-B1 / T_keV**(1/3))
